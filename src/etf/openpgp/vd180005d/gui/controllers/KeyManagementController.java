...
import etf.openpgp.vd180005d.gui.utils.KeyInfoObservableLists;
...
public class KeyManagementController {
    ...
    private void generateNewKeyPair(MouseEvent event) {
        Alert alert = new Alert(Alert.AlertType.INFORMATION);
        FXMLLoader loader = new FXMLLoader(this.getClass().getClassLoader().getResource("generateKeysDialog.fxml"));
        DialogPane dialogPane = null;
        try {
            dialogPane = loader.load();
        } catch (IOException e) {
        ...
        dialogPane.getStylesheets().add(this.getClass().getClassLoader().getResource("style.css").toExternalForm());
    ...
    private void backAction(ActionEvent event) {
        UIUtils.getInstance().switchPages("home.fxml");
    }
